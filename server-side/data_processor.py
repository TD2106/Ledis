class DataProcessor:
    ...
    def process_input(input_string, user):
        ...
        if input_array[0] not in DataProcessor.ACTIONS:
            ...
            if (input_array[0] == 'RPUSH' and len(input_array) < DataProcessor.COMMANDS_LENGTH[input_array[0]]) or \
             (input_array[0] != 'RPUSH' and len(input_array) != DataProcessor.COMMANDS_LENGTH[input_array[0]]):
                return "Wrong command"
            else:
